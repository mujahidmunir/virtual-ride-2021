...
@section('content')
    ...
    <div class="alert alert-danger" role="alert">
        ...
        <p>
            ...
            <br>
            Gunakan Nomor telepon whatsapp pada form nomor Whatsapp,
            <br>
            dan nomor yang digunakan pada bjbDigiCash untuk mengisi form nomor DigiCash
            <br>
            Lakukan pembayaran menggunakan applikasi bjbDigiCash atau <a target="_blank" href="https://play.google.com/store/apps/details?id=com.bjb.digicashcustomer&hl=en&gl=US">Download disini</a>
            <br>
            Pastikan pembayaran menggunakan nomor DigiCash yang diinputkan pada form dibawah, selain nomor yang diinputkan maka pembayaran tidak syah.
        </p>
        <hr>
        <p class="font-weight-bold">Pembayaran yang diterima hanya menggunakan bjb DigiCash, Selain itu tidak akan diterima, dan tidak ada refund dana</p>
    </div>
<div class="card">
    ...
    <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-lg-6 mb-3 mt-3">
                    ...
                    <input type="text" name="name" required value="{{Auth::user()->name}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama">
